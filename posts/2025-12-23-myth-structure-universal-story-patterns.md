---
title: "神話の構造とは？世界中の物語に共通する普遍的パターンを解説"
description: "なぜ世界各地の神話には似た構造があるのか。ジョーゼフ・キャンベルの「英雄の旅」を軸に、神話学の基本概念と現代物語への応用を中級者向けに丁寧に解説します。"
date: "2025-12-23"
slug: "myth-structure-universal-story-patterns"
category: "言葉と文学"
tags: [神話学, 物語論, 比較文化]
keywords: [神話の構造, 英雄の旅, モノミス, ジョーゼフ・キャンベル, 物語パターン]
reading_time: 10
...
神話構造の詳細と現代物語への応用を動画でさらに深掘りしています。ぜひご覧ください。

## 📚 おすすめ書籍

- **『千の顔をもつ英雄』ジョーゼフ・キャンベル**：モノミス理論の原典。神話学の古典として必読の一冊です。（Amazon検索：`千の顔をもつ英雄 キャンベル`）
- **『神話の力』ジョーゼフ・キャンベル、ビル・モイヤーズ**：対話形式で読みやすく、キャンベル思想の入門書として最適。（Amazon検索：`神話の力 キャンベル`）
- **『神話の法則』クリストファー・ヴォグラー**：物語創作者向けに英雄の旅を実践的に解説した実用書。（Amazon検索：`神話の法則 ヴォグラー`）
