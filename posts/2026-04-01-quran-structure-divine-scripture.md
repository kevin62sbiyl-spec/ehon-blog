---
title: "コーランとは何か｜神の言葉が記された聖典の構造と特徴を解説"
description: "コーランの構造・成立過程・特徴を中級者向けに解説。スーラとアーヤの仕組み、啓示の背景、他の聖典との違いまで、イスラームの聖典を深く理解するための知識を網羅します。"
date: "2026-04-01"
slug: "quran-structure-divine-scripture"
category: "宗教"
tags: [イスラーム, 聖典, 宗教学]
keywords: [コーラン, クルアーン, イスラーム聖典, スーラ, 啓示]
reading_time: 10
...
コーランの詳しい構造と歴史的背景をブログ記事で深掘り解説しています。概要欄のリンクからどうぞ。

## 📚 おすすめ書籍

- **『コーラン（上中下）』井筒俊彦訳**：日本語で読める最も定評ある翻訳。訳注も充実し初学者から研究者まで必携。（Amazon検索：`コーラン 井筒俊彦`）
- **『イスラーム文化』井筒俊彦**：コーランの思想的背景を含むイスラーム文化全体の入門書として最適。（Amazon検索：`イスラーム文化 井筒俊彦`）
- **『コーラン入門』牧野信也**：コーランの構造・内容・成立を学術的かつ平易に解説した入門書。（Amazon検索：`コーラン入門 牧野信也`）
