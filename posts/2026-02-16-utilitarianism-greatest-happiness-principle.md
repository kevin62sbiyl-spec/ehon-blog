---
title: "功利主義入門｜最大多数の最大幸福は本当に正しいのか？"
description: "功利主義の基本原理「最大多数の最大幸福」を丁寧に解説。ベンサムとミルの思想の違い、現代社会での応用例、そして功利主義への批判と限界まで、中級者向けに深掘りします。"
date: "2026-02-16"
slug: "utilitarianism-greatest-happiness-principle"
category: "哲学・思想"
tags: [倫理学, 功利主義, 政治哲学]
keywords: [功利主義, 最大多数の最大幸福, ベンサム, ミル, 倫理学]
reading_time: 10
...
功利主義の全体像を動画でわかりやすく解説しています。哲学をもっと深く学びたい方はぜひご覧ください。

## 📚 おすすめ書籍

- **『功利主義論』J.S.ミル**：功利主義の古典的名著。質的快楽論を通じてベンサムを超える思想の深化が学べます。（Amazon検索：`ミル 功利主義論`）
- **『あなたが救える命』ピーター・シンガー**：現代の功利主義者シンガーによる実践的な倫理の書。効果的利他主義の入門に最適です。（Amazon検索：`シンガー あなたが救える命`）
- **『正義論』ジョン・ロールズ**：功利主義への最も影響力ある批判書。分配的正義の観点から功利主義の限界を理解できます。（Amazon検索：`ロールズ 正義論`）
